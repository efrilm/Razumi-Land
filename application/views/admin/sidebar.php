<div class="app-sidebar">
    <div class="logo">
        <a href="<?= base_url('a/properties') ?>" class="logo-icon"><span class="logo-text"><?= $company_name ?></span></a>
    ...
    <div class="app-menu">
        <ul class="accordion-menu">
            ...
            <li class="<?php if ($this->uri->segment(2) == 'banner') {
                ...
                <a href="<?= base_url('a/banner') ?>" class="active"><i class="material-icons-two-tone">image</i><?= plang('Banner') ?></a>
            </li>
