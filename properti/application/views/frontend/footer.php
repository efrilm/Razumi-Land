    ...
    <div class="container">
        <div class="grid grid-cols-12 gap-x-[30px] mb-[-30px]">
            <div class="col-span-12 sm:col-span-6 lg:col-span-4 mb-[30px]">
                <a href="<?= base_url() ?>" class="block mb-[25px]">
                    <img src="<?= base_url() ?>assets/images/logo/<?= $logo ?>" width="99" height="46" loading=lazy alt="footer logo">
                </a>
                <p class="mb-[5px] xl:mb-[40px] max-w-[270px]">
                    <?= plang('is a property development service company that was born as a form of commitment to contribute to development and sales with sharia concepts in accordance with Islamic law') ?>
                </p>
                <p class="text-sm hidden md:block">&copy;All Rights Reserved - Privacy Policy</p>
            </div>
            <div class="col-span-12 sm:col-span-6 lg:col-span-3 mb-[30px]">
                <h3 class="font-recoleta font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]"><?= plang('Information') ?><span class="text-secondary">.</span></h3>
                <ul class="text-[16px] leading-none mb-[-20px]">
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="<?= base_url('about') ?>"><?= plang('About us') ?></a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="<?= base_url('property') ?>"><?= plang('Properties') ?></a></li>
                    <li class="mb-[20px]"><a class="inline-block transition-all hover:text-secondary" href="<?= base_url('contact') ?>"><?= plang('Contact') ?></a></li>
                </ul>
            </div>
            <div class="col-span-12 sm:col-span-6 lg:col-span-2 mb-[30px]">
                <h3 class="font-recoleta font-normal text-[22px] leading-[1.222] text-primary mb-[20px] lg:mb-[30px]">
                    <?= plang('Address') ?><span class="text-secondary">.</span>
                </h3>
                <p><?= $address ?></p>
                <ul class="inline-flex items-center justify-center mt-[20px]">
                    <li class="first:ml-0 ml-[15px]"><a href="<?= $facebook ?>" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
                    ...
                    <li class="ml-[15px]"><a href="<?= $facebook ?>" class="w-[26px] h-[26px] transition-all rounded-full bg-primary flex items-center justify-center hover:drop-shadow-[0px_4px_10px_rgba(0,0,0,0.25)] text-white hover:bg-secondary">
